import type { RaindropApiResponse, RaindropRequest, ValidationResult } from "../../core/types.ts";
...
export function formatItems(data: RaindropApiResponse, summary: string): string {
